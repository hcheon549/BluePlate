      ...
      >
        <div className="innerContent">
          ...
          <p><span className="miniText">
            Any information and actions in this page including, but not limited to, name and location of restaurants, menu items and reservations are for demonstration purposes only. Neither BluePlattr nor restaurants will recognize or honor reservations made in this page.
          </span></p>
