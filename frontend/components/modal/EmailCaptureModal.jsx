...
const EmailCaptureModal = (props) => {
  ...
  if (props.landing){
    ...
    subHead = 'BluePlattr is coming to Rutgers University next semester! It\'s the easiest, most affordable and convinient way to do meals, and we are sure that you will love it. Sign up and get an exclusive offer for next semester\'s plan!'
  } else {
