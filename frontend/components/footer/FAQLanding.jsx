...
const Questions = [
  ...
  'As a parent, how can I sign up the BluePlattr meal plan for my child(ren)?'
]
...
const Answers = [
  ...
  <div>
    <p>You can get meals at any participating restaurant in the BluePlattr network.</p>
    <p>BluePlattr meal plans are currently available for students, faculty and community members of the Rutgers University-New Brunswick Campus. But we are a fast growing startup! If you want us to reach to your campus, please, contact us!</p>
  </div>,
  <div>
    <p>BluePlattr is available everyday except on the following holidays: New Year’s Day, Memorial Day, July 4th, Labor Day, Thanksgiving Day, the day after Thanksgiving, and Christmas Day.</p>
    <p>In cases where Christmas and/or New Year’s fall on a weekend, it is possible that BluePlattr will observe that holiday on the closest weekday.</p>
  </div>,
  <div>
    <p>Your meal plan covers 100% of the cost of your meal, whether it’s for lunch or dinner. There are no additional charges.</p>
  </div>,
  <div>
    <p>Your BluePlattr cycle begins the day you sign up for one of our plans. Your cycle will last until the last day of the semester according to the university’s official academic calendar. Please, refer to your university’s official website for the exact date.</p>
  </div>,
  <div>
  ...
  <div>
    <p>Please email us at hello@BluePlattr.io and we can help set up an account for your child(ren)!</p>
  </div>
]
