...
const Answers = [
  <div>
    ...
    <p>BluePlattr offers affordable, convenient, and flexible meal plan subscriptions giving users access to local restaurants on and around your campus. BluePlattr aims to provide you with a quick, simple, and convenient system for you to get amazing lunch and dinner meals every day. Users select their lunch and/or dinner in advance through the Blueplate website, as early as the night before, and pick it up at the time of their choosing. Deciding what to eat on a tight schedule and budget has never been easier.</p>
  </div>,
  <div>
