  ...
  return(
    <section className="footerPage">
      ...
      <div className="content updates">
        ...
        <ul>
          <li>- Your meal credits are redeemable at any of the restaurants on BluePlattr until the end of the semester.</li>
          <li>- You will not be charged for any renewal.</li>
          <li>- You will be able to purchase additional meal credits that you can redeem by the end of the semester if you need it in the future when on-site classes resume.</li>
        </ul>
        <p></p>
        <p>Should you find yourself in need of assistance, please contact us by email at <a href="mailto:support@blueplattr.com">support@blueplattr.com.</a></p>
